...
class PhotoshotIndex extends Component
{
    ...
    #[On('render-photoshot-index')] //ESCUCHADOR DE EVENTO
    public function render()
    {
        $photoshots = Photoshot::where('store_id', $this->store_id)
        ...
        return view('livewire.admin.proof.photoshot-index', compact('photoshots', 'stores'));
    }
}
