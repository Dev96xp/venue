...
class PageController extends Controller
{
    ...
    public function select_images(Sectionx $sectionx)
    {
        return view('admin.pages.select_images', compact('sectionx'));
    }


    public function save_images(Request $request, Sectionx $sectionx)
    {
        // ya funciona
        ...
        $ruta = storage_path() . '/app/public/sectionx/' . $nombre;   //Ruta completa con nombre
