...
@section('content_header')
    <h1>Select files para la seccion: {{ $section->name }}</h1>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    ...
                    @livewire('admin.sections.display-images', ['section' => $section], key($section->id))
                    ...
                    <form action="{{ route('admin.sections.save_files', $section) }}" method="POST" class="dropzone"
