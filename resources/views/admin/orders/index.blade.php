    ...
    <x-admin-layout>
        <div class="container py-12">
            ...
            <section class="grid lg:grid-cols-4 gap-6 text-white">
                ...
                <a href="{{route('admin.orders.index') . "?status=4"}}" class="bg-green-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                ...
                <a href="{{route('admin.orders.index') . "?status=5"}}" class="bg-pink-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                        ...
                        @foreach ($orders as $order)
                            <li class="">
                                ...
                                <span>
                                    ...
                                    {{-- ORDER DATE --}}
                                    <br>
                                    {{ \Carbon\Carbon::parse($order->created_at)->format('l j F') }}
                                </span>
                                <span class="mx-4">
