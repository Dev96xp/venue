<div class="col-span-12 sm:col-span-6 lg:col-span-6">
    ...
    <div class="flex flex-row bg-white shadow-sm rounded p-3">
        ...
        <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl bg-blue-100 text-blue-500">
            <i class="text-lg fas fa-gem"></i>
        </div>

        <div class="flex flex-col flex-grow ml-4">

            @if ($event->decoration()->exists())
                <div class="text-lg text-blue-500">Decoracion</div>
                <div><span class="text-bold"> {{ $decoration->name }}</span></div>
            @else
                <div class="text-lg text-gray-500">Decoracion</div>
