<div class="col-span-12 sm:col-span-6 lg:col-span-6">
    ...
    <div class="flex flex-row bg-white shadow-sm rounded p-3">
        ...
        <div class="flex flex-col flex-grow ml-4">
            ...
            @if ($event->cleaning()->exists())
                <div class="text-lg text-blue-500">Limpieza</div>
                <div><span class="text-bold"> {{ $cleaning->name }}</span></div>
            @else
                <div class="text-lg text-gray-500">Limpieza</div>
