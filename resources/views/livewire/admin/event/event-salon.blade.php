<div class="border border-zinc-600 col-span-12 sm:col-span-6 lg:col-span-6">
    <div class="p-2">
        {{-- card - HEADER - Venues - Salon - Hall --}}
        <div class="flex flex-row bg-white shadow-sm rounded p-3">
            ...
            <div class="flex flex-col flex-grow ml-4">
                ...
                @if ($event->venue()->exists())
                    <div class="text-lg text-blue-500">Salon</div>
                    <div><span class="text-bold"> {{ $venue->name }}</span></div>
                @else
                    <div class="text-lg text-gray-500">Salon</div>
                ...
                <article class="card" x-show="open">
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <input wire:model="name" class="form-control shadow-sm">
                            </div>

                            <div>
                                <input wire:model="description" class="form-control shadow-sm">
                            </div>
