<div>
    ...
    <div class="grid grid-cols-6 gap-2">
        ...
        <div class="col-span-3">
            ...
            @if ($sectionx->images->count())
                <section class="bg-white shadow-xl rounded-lg p-6 mb-4">
                    <h1 class="text-2xl text-center font-semibold mb-2">Images list by Section - <span class="text-purple">[ {{ $sectionx->name }} ]</span></h1>
        ...
        <div class="col-span-2 mb-4">
                @livewire('admin.page.images-section-list', ['sectionx' => $sectionx])
        </div>
