<header x-data="{ open: false }" class="bg-gray-400 sticky top-0" style="z-index: 900">

    {{-- MENU DE NAVEGACION --}}

    <div class="cointainer flex items-center h-16 justify-between md:justify-start">
        {{-- Link --}}
        {{-- Esta linea permiteque se muestre/>oculte el menu --}}
        ...
        {{-- DROPDOWN - Bolsita de Compras --}}
        {{-- IMPORTANTE
             a) Pantalla pequeña APARECE
             b) Pantalla mediana y mas grande DESAPARECE --}}
            ...
            @auth
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link href="{{ route('sales.orders.index') }}">
                            Mis ordenes
                        </x-dropdown-link>
