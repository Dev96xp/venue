<x-app-layout>
    ...
    <div class="relative isolate mt-32 pb-20 sm:mt-56 sm:pt-32">
                ...
                <div
                        ...
                        <div class="space-y-8 xl:row-span-2">
                            ...
                            <figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
                                <blockquote class="text-gray-900">
                                    <p>“Fue todo un dia lleno de sorpresas, la mas importante es el servicio con que contaba
                                ...
                                <figcaption class="mt-6 flex items-center gap-x-4">
                                    <img class="h-10 w-10 rounded-full bg-gray-50"
                                        ...
                                        alt="">
                                    <div>
                                        <div class="font-semibold">Rubu ice puro</div>
                            ...
                            <figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
                                <blockquote class="text-gray-900">
                                    <p>“Hermoso lucio THE PALACE HALL, su decoracion muy bonita y elegante, era tan perfecto todo
                    ...
                    <div class="space-y-8 xl:contents xl:space-y-0">
                        <div class="space-y-8 xl:row-start-1">
                            <figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
                                <blockquote class="text-gray-900">
                                    <p>“Wow, espectacular THE PALACE HALL, muy elegante y muy espacioso, todo mundo se divirtio
                        ...
                        <div class="space-y-8 xl:row-span-2">
                            <figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
                                <blockquote class="text-gray-900">
                                    <p>“El servicio de THE PALACE HALL TEAM, son un personal tan agradable, que me ayudaron con todo
                                        inclusive me dejaron trater mi propia comida y un dia antes pude practicar mi baile sorpresa
                                        la musica tenia todo lo necesario ara conectar su equipo y si cortes de electricidad, todo me
                                        encanto, su decoracion es muy bonita y elegante, y siempre al pendiente de la limpieza, ademas
