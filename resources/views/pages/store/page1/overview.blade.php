<x-store-layout>
    ...
    {{-- Pagina #1 para ventas de productos
        USO: Muestra en detalle un producto para su venta --}}
                ...
                <div class="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
                    <div class="lg:col-span-5 lg:col-start-8">
                        <div class="flex justify-between">
                            ...
                            <p class="text-xl font-medium text-gray-900">${{ number_format($product->price, 2) }}</p>
                        </div>
                        <!-- Reviews -->
                        <div class="mt-4">
                    ...
                    {{-- Podria ser el componente --}}
                    @livewire('pages.store.product-overview', ['product' => $product])
