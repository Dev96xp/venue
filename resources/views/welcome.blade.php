    ...
    <section>
        ...
        <div class="w-full mx-auto px-4 sm:px-6 lg:px-64 py-40 opacity-75 relative bg-fixed bg-center bg-no-repeat bg-cover hover:opacity-100"
            ...
            <div class="w-full md:w-3/4 lg:w-3/4">
                <h1 class="text-black text-8xl py-6" style="font-family: Sche">THE PALACE HALL</h1>
                <h1 class="text-white text-6xl font-bold" style="font-family: Montserrat">
